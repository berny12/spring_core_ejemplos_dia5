...
public class ClienteServiceTxProgramaticasImpl implements ClienteService {
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.synergyj.cursos.spring.service.ClienteService#creaCliente(com.synergyj.cursos.spring.
	 * service.Cliente)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.synergyj.cursos.spring.service.ClienteService#findClienteById(java.lang.Long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.synergyj.cursos.spring.service.ClienteService#actualizaCliente(java.lang.Long,
	 * java.lang.String)
	 */
	@Override
	public Cliente actualizaCliente(final Long id, final String nombre) {
		logger.debug("Actualizando cliente, creando transacción");
		// TODO C ) hacer este código transaccional empleando TransactionCallback
		Cliente cliente;
